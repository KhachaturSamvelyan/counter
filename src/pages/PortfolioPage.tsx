...
export function PortfolioPage() {
  return (
    <AppLayoutWithActive activeSection="Portfolio">
      <motion.section
      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-5xl font-light text-main">Portfolio</h2>
          <p className="mt-3 text-sm text-muted">No portfolio data yet</p>
          <div className="mx-auto mt-16 grid h-28 w-28 place-items-center rounded-full border border-[#2B2EC4]/30 bg-[#1F3E6F]/15">
            <Landmark size={46} className="text-[#c4b5fd]" />
          </div>
        </div>
      </motion.section>
    </AppLayoutWithActive>
